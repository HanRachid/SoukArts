...
export default function FeaturesShop() {
  return (
    <div className='w-full h-auto mt-20 px-20 pb-20'>
      <div className='flex justify-between pb-20 items-center w-full px-10'>
        <h1 className='text-7xl font-primary text-colorBrown '>
          FEATURED SHOPS
        </h1>
        <button className='flex items-center justify-center'>
          <span className='text-colorBrown font-medium'>
            Explore More Featured shops
          </span>
          <GoChevronRight className='h-6 w-auto' />
        </button>
      </div>
      <div className='w-full h-auto gap-4 grid grid-cols-3 grid-rows-2 px-10'>
        <div className='col-span-1 overflow-hidden row-span-2 relative bg-colorBeige rounded-t-3xl rounded-bl-3xl border-2 border-black'>
          ...
          <button className='w-full py-5 absolute bottom-0 left-0 border-t-2 border-black'>
            ByMikwi
          </button>
        </div>
        <div className='col-span-1 row-span-1 rounded-tl-3xl overflow-hidden border-black border-2 relative'>
          ...
          <button className='w-full bottom-0 absolute py-5 border-t-2 border-black bg-colorBeige'>
            NorthAfricanWeavers
          </button>
        </div>
        <div className='col-span-1 row-span-1 overflow-hidden relative rounded-tr-3xl border-2 border-black'>
          ...
          <button className='w-full absolute bottom-0 py-5 border-t-2 border-black bg-colorBeige'>
            Homdiyhardware
          </button>
        </div>
        <div className='col-span-2 row-span-1 relative overflow-hidden border-2 border-black rounded-br-3xl'>
          <img src={wssada} className='w-f' />
          <button className='w-full py-5 bg-colorBeige border-t-2 border-black absolute bottom-0'>
            Marocainrie
          </button>
        </div>
      </div>
