...
export default function ProductDetailsComponent({
  ...
  function handleAddToCart() {
    dispatch(setCartState([...cart, product]));
    console.log(cart);
  }
  return (
      ...
      <div className='flex gap-4 items-center'>
        ...
        >
          ...
          <button
            ...
            className='h-11 w-[243px] bg-colorGold text-white font-secondary tracking-widest rounded-none rounded-tr-[7px] rounded-bl-[7px] hover:bg-colorGold/90 hover:scale-[1.02]'
          >
            Add to cart
          </button>
        </ConfigProvider>
