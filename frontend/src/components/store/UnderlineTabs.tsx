    ...
    <Box sx={{ width: "100%" }}>
      <Box sx={{ borderBottom: 2, borderColor: "divider" }}>
        ...
        >
          <StyledTab
            label={
              <div className="flex gap-32 text-xl tracking-widest">
                Products
              </div>
            }
          />
          <StyledTab
            label={
              <div className="flex gap-32 text-xl tracking-widest">Reviews</div>
            }
          />
          <StyledTab
            label={
              <div className="flex gap-32 text-xl tracking-widest">About</div>
            }
          />
          <StyledTab
            label={
