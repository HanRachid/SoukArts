            ...
            <div className="shadow sm:overflow-hidden sm:rounded-md">
              <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <select className="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-gold-500 focus:outline-none focus:ring-gold-500 sm:text-sm">
