...
export default function Footer() {
  ...
  return (
    <>
      <footer className="font-secondary border border-t-4 border-t-colorGold">
        {/* Footer-part-one */}
                    ...
                    >
                      ...
                      <Typography id="modal-desc" textColor="text.tertiary">
                        ...
                        <div className="grid grid-cols-3 gap-6 md:gap-32 text-medium font-secondary md:px-14 pt-7">
                          ...
                          <div>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Morocco</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Bahreïn</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Oman</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Qatar</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Koweit</p>
                          </div>

                          <div>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Germany</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Belgium</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">France</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Italy</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Spain</p>
                           </div>

                          <div>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Japan</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">China</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Singapour</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">USA</p>
                            <p className="border-b-[1px] border-b-colorGold pb-4 mb-4 md:pb-7 md:mb-7 ">Canada</p>
                          </div>
